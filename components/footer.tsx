        ...
        <div className="grid gap-10 lg:grid-cols-[1.3fr_1fr_1fr_1fr]">
          <div className="space-y-4">
            ...
            <p className="max-w-lg text-sm leading-relaxed text-white/85">
              Мы готовим всегда свежие и сочные блюда: шаурма, буртуч, кесадилья и вкусные закуски. Используем только качественные продукты — свежие овощи, филе курицы и свиной карбонат от проверенных поставщиков. Заберите заказ в ближайшем филиале или оформите
              доставку по Чите.
            </p>
